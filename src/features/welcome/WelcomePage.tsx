    ...
    <div className="nb-welcome">
      ...
      <section className="nb-welcome-section">
        ...
        <ul className="nb-welcome-list">
          ...
          <li>
            <strong>%%cribl_save_search_lookup</strong> / <strong>%%cribl_load_search_lookup</strong> — Upload a
            pandas DataFrame as a Search lookup CSV (API group <code className="nb-welcome-code">default_search</code>
            ), or load a lookup file back into the kernel. Use <code className="nb-welcome-code">replace=true</code>{' '}
            to overwrite an existing lookup.
          </li>
          <li>
