...
const cribl = {
  ...
  cells: [
    ...
    },
    {
      ...
      metadata: {},
      source: [
        '## Original KQL flow (separate DataFrame variable)\n',
        '\n',
        'This cell runs the original query form directly as KQL and stores results in `kql_df`.\n',
      ].join(''),
    },
    {
      cell_type: 'code',
      ...
      outputs: [],
      source: [
        '%%cribl_search var=kql_df preview=true limit=1000 lang=kql\n',
